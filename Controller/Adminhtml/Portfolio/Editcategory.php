...
class Editcategory extends \Risecommerce\Portfolio\Controller\Adminhtml\Portfolio
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('Risecommerce\Portfolio\Block\Adminhtml\Editcategory')
        );
